package questions; /**
 * questions.ArdoiseMagique.java
 *
 * @author <a href="mailto:gery.casiez@lifl.fr">Gery Casiez</a>
 * @version
 */

import utils.EcouteurDeSouris;
...
public class ArdoiseMagique extends JPanel {
    ...
    public ArdoiseMagique(){
        ...
        addMouseListener(new EcouteurDeSouris(this));
        addMouseMotionListener(new EcouteurDeSouris(this));
    }
    ...
    public static void main(String[] args) {
        ...
        JFrame window = new JFrame("DESSINE ! ");
        ArdoiseMagique am = new ArdoiseMagique();
        window.add(am);
        window.pack();
